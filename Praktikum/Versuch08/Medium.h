...
/*! \brief Basisklasse fuer saemtliche Medien
*
* Diese Klasse stellt eine Basisklasse fuer Objekte dar, die Medien beschreiben
...
public:
     ...
     *
     * \return bool: true,  wenn die Ausleihbeschruenkungen erfuellt sind und das Medium ausgeliehen werden kann
     *               false, wenn die Ausleihbeschruenkungen nicht erfuellt sind und das Medium nicht ausgeliehen werden kann
     */
    virtual bool ausleihen(Person person, Datum ausleihdatum);

    /*!
     * @brief Gibt ein Medium in die Buecherei zurueck
     */
    void zurueckgeben();
     ...
     *
     * \return int: gibt die ID des Mediums zurueck
     */
    unsigned int getID();
